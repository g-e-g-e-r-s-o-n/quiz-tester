...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.option.title_singular')); ?>

    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.options.update", [$option->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('question') ? 'is-invalid' : ''); ?>" name="question_id" id="question_id" required>
                    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id); ?>" <?php echo e(($option->question ? $option->question->id : old('question_id')) == $id ? 'selected' : ''); ?>><?php echo e($question); ?></option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control <?php echo e($errors->has('option_text') ? 'is-invalid' : ''); ?>" name="option_text" id="option_text" required><?php echo e(old('option_text', $option->option_text)); ?></textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('points') ? 'is-invalid' : ''); ?>" type="number" name="points" id="points" value="<?php echo e(old('points', $option->points)); ?>" step="1">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\PhpstormProjects\Laravel-Test-Result-PDF\resources\views/admin/options/edit.blade.php ENDPATH**/ ?>